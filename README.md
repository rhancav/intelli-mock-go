...
![Build](https://github.com/rhancav/mockgen-easy/workflows/Build/badge.svg)
...
- Manually:
  ...
  Download the [latest release](https://github.com/rhancav/mockgen-easy/releases/latest) and
